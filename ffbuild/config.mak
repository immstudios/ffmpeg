...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local --enable-nonfree --enable-gpl --enable-version3 --enable-shared --enable-pic --enable-fontconfig --enable-libass --enable-libfreetype --enable-libfribidi --enable-libmp3lame --enable-libtwolame --enable-libwebp --enable-libx265 --enable-libopus --enable-libzvbi --enable-libv4l2 --enable-openssl --enable-libxml2 --enable-librubberband --enable-opencl --enable-libfdk-aac --enable-libx264 --enable-decklink --enable-libndi_newtek --enable-libsrt --enable-libklvanc --enable-libopenjpeg
prefix=/usr/local
...
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/uuid -I/usr/include/fribidi -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/local/include -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/fribidi -I/usr/local/include/openjpeg-2.4 -I/usr/include/opus -I/usr/include/opus  -I/usr/local/include -I/usr/local/include/srt    -DX264_API_IMPORTS -I/usr/local/include   -I/usr/include/libxml2      -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lstdc++ -lndi -lstdc++ -lndi -lm -lxcb -lxcb-shape -lxcb-xfixes -lklvanc -lv4l2 -ldl
EXTRALIBS-avfilter=-pthread -lm -lrubberband -lstdc++ -lfribidi -lass -lOpenCL -lfontconfig -lfreetype -lfreetype
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lxml2 -lz -lssl -lcrypto -L/usr/local/lib -lsrt
EXTRALIBS-avcodec=-lwebpmux -lwebp -pthread -lm -lzvbi -lm -lpthread -lm -lpng -lz -lz -L/usr/local/lib -lfdk-aac -lmp3lame -lm -L/usr/local/lib -lopenjp2 -lopus -ltwolame -lwebp -L/usr/local/lib -lx264 -lx265
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lm -lOpenCL
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
